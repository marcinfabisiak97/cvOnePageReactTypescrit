...
const Technolgie = (props) => {
  ...
  return (
    <React.Fragment>
      {expander ? (
        <div className="technolgiesBricks technolgiesBricks--expand">
          ...
          <img
            className="technolgiesBricks__cliker technolgiesBricks__cliker--rotate"
            onClick={() => setExpander("")}
            src={rightPointer}
            alt="pointer"
          />
        ...
        <div className="technolgiesBricks">
          ...
          <img
            className="technolgiesBricks__cliker"
